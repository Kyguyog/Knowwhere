function createUnityInstance(t, n, l) {
    ...
    function r(e) {
        ...
        (n += "\n" + (r = r.startsWith(n) ? r.substring(n.length) : r).trim()) && b.stackTraceRegExp && b.stackTraceRegExp.test(n) && x(n, e.filename || t && (t.fileName || t.sourceURL) || "", e.lineno || t && (t.lineNumber || t.line) || 0)
    }
    function e(e, t, n) {
        var r = e[t];
    ...
    var o, b = {
        ...
        printErr: function(e) {
            console.error(e),
            "string" == typeof e && -1 != e.indexOf("wasm streaming compile failed") && (-1 != e.toLowerCase().indexOf("mime") ? c('HTTP Response Header "Content-Type" configured incorrectly on the server for file ' + b.codeUrl + ' , should be "application/wasm". Startup time performance will suffer.', "warning") : c('WebAssembly streaming compilation failed! This can happen for example if "Content-Encoding" HTTP header is incorrectly enabled on the server for file ' + b.codeUrl + ", but the file is not pre-compressed on disk (or vice versa). Check the Network tab in browser Devtools to debug server header configuration.", "warning"))
        },
    ...
    n)
        b[o] = n[o];
    b.streamingAssetsUrl = new URL("StreamingAssets",document.querySelector('base')?document.querySelector('base').href:document.baseURI).href;
    ...
    ;
    var f, h, m, p, g, w, v, y, k, _ = {
        Module: b,
        SetFullscreen: function() {
            if (b.SetFullscreen)
                return b.SetFullscreen.apply(b, arguments);
            b.print("Failed to set Fullscreen mode: Player not loaded yet.")
        },
        SendMessage: function() {
            if (b.SendMessage)
                return b.SendMessage.apply(b, arguments);
        ...
        GetMetricsInfo: function() {
            ...
            return {
                ...
                webAssemblyStartupTime: b.HEAPU32[c >> 2] - (b.webAssemblyTimeStart || 0),
    ...
    function x(e, t, n) {
        -1 == e.indexOf("fullscreen error") && (b.startupErrorHandler ? b.startupErrorHandler(e, t, n) : b.errorHandler && b.errorHandler(e, t, n) || (console.log("Invoking error handler due to\n" + e),
        "function" == typeof dump && dump("Invoking error handler due to\n" + e),
        x.didShowErrorMessage || (-1 != (e = "An error occurred running the Unity content on this page. See your browser JavaScript console for more info. The error was:\n" + e).indexOf("DISABLE_EXCEPTION_CATCHING") ? e = "An exception has occurred, but exception handling has been disabled in this build. If you are the developer of this content, enable exceptions in your project WebGL player settings to be able to catch the exception or see the stack trace." : -1 != e.indexOf("Cannot enlarge memory arrays") ? e = "Out of memory. If you are the developer of this content, try allocating more memory to your WebGL build in the WebGL player settings." : -1 == e.indexOf("Invalid array buffer length") && -1 == e.indexOf("Invalid typed array length") && -1 == e.indexOf("out of memory") && -1 == e.indexOf("could not allocate memory") || (e = "The browser could not allocate enough memory for the WebGL content. If you are the developer of this content, try allocating less memory to your WebGL build in the WebGL player settings."),
        alert(e),
    ...
    function S(e, t) {
        if ("symbolsUrl" != e) {
            ...
            for (e in b.downloadProgress) {
                if (!(n = b.downloadProgress[e]).started)
                    return;
                a++,
    ...
    function U(e) {
        return U.link = U.link || document.createElement("a"),
        U.link.href = e,
        U.link.href
    }
    b.SystemInfo = function() {
        ...
        for (var c = [["Windows (.*?)[;)]", "Windows"], ["Android ([0-9_.]+)", "Android"], ["iPhone OS ([0-9_.]+)", "iPhoneOS"], ["iPad.*? OS ([0-9_.]+)", "iPadOS"], ["FreeBSD( )", "FreeBSD"], ["OpenBSD( )", "OpenBSD"], ["Linux|X11()", "Linux"], ["Mac OS X ([0-9_\\.]+)", "MacOS"], ["bot|google|baidu|bing|msn|teoma|slurp|yandex", "Search Bot"]], d = 0; d < c.length; ++d)
            if (r = s(c[d][0], a, 1)) {
                n = c[d][1],
                r = r.replace(/_/g, ".");
                break
        ...
        function o() {
            return void 0 === e ? a.arrayBuffer().then(function(e) {
                ...
                if (e.done) {
                    ...
                    if (f < c)
                        return d.slice(0, f);
                    for (var t = new Uint8Array(f), n = (t.set(d, 0),
                    h), r = 0; r < u.length; ++r)
                        t.set(u[r], n),
                        n += u[r].length;
                    return t
                }
                return f + e.value.length <= d.length ? (d.set(e.value, f),
                h = f + e.value.length) : u.push(e.value),
                f += e.value.length,
                i({
                    type: "progress",
                    response: a,
    ...
    E.prototype.cleanUpCache = function() {
        ...
        return this.getMetaDataEntries().then(function(e) {
            for (var t = e.metaDataEntries, n = e.cacheSize, r = [], o = [], a = 0; a < t.length; ++a)
                t[a].version == b.productVersion ? o.push(t[a]) : (r.push(t[a]),
                n -= t[a].size);
            o.sort(function(e, t) {
    ...
    ,
    E),
    b.cachedFetch = (v = b.UnityCache,
    y = b.fetchWithProgress,
    k = b.readBodyWithProgress,
    function(o, a) {
        var e, t, i = v.getInstance(), s = U("string" == typeof o ? o : o.url), l = {
            enabled: (e = s,
        ...
        function c(n, r) {
            return fetch(n, r).then(function(e) {
                var t;
                return !l.enabled || l.revalidated ? e : 304 === e.status ? (l.revalidated = !0,
                i.updateRequestMetaData(l.metaData).then(function() {
                    C("'" + l.metaData.url + "' successfully revalidated and served from the browser cache")
                }).catch(function(e) {
                    C("'" + l.metaData.url + "' successfully revalidated but not stored in the browser cache due to the error: " + e)
                }),
                k(l.response, r.onProgress, r.enableStreamingDownload)) : 200 == e.status ? (l.response = e,
                l.metaData.updatedAt = l.metaData.accessedAt,
                l.revalidated = !0,
                t = e.clone(),
                k(e, r.onProgress, r.enableStreamingDownload).then(function(e) {
                    return l.metaData.size = e.parsedBody.length,
                    Promise.all([i.storeRequest(n, t), i.updateRequestMetaData(l.metaData)]).then(function() {
                        C("'" + s + "' successfully downloaded and stored in the browser cache")
                    }).catch(function(e) {
                        C("'" + s + "' successfully downloaded but not stored in the browser cache due to the error: " + e)
                    }),
                    e
                })) : (C("'" + s + "' request failed with status: " + e.status + " " + e.statusText),
                k(e, r.onProgress, r.enableStreamingDownload))
            })
        }
        return a && (l.control = a.control,
        ...
        l.response = null,
        l.enabled ? i.loadRequest(s).then(function(e) {
            var n, r, t;
            ...
            "immutable" == l.control ? (l.revalidated = !0,
            i.updateRequestMetaData(r).then(function() {
                C("'" + l.metaData.url + "' served from the browser cache without revalidation")
            }),
            k(n, a.onProgress, a.enableStreamingDownload)) : (e = s,
            ...
            return C("Failed to load '" + l.metaData.url + "' from browser cache due to the error: " + e),
            y(o, a)
        }) : y(o, a)
    }
    );
            ...
            require: function(e) {
                var t, n = {
                    "inflate.js": function(e, t, n) {
                        ...
                        function s(e, t) {
                            if ((t = new i(t)).push(e, !0),
                            t.err)
                                throw t.msg || r[t.err];
                            return t.result
                        }
                        i.prototype.push = function(e, t) {
                            var n, r, o, a, i, s = this.strm, l = this.options.chunkSize, c = this.options.dictionary, d = !1;
                            if (this.ended)
                                return !1;
                            r = t === ~~t ? t : !0 === t ? m.Z_FINISH : m.Z_NO_FLUSH,
                            "string" == typeof e ? s.input = h.binstring2buf(e) : "[object ArrayBuffer]" === b.call(e) ? s.input = new Uint8Array(e) : s.input = e,
                            s.next_in = 0,
                            s.avail_in = s.input.length;
                            do {
                                if (0 === s.avail_out && (s.output = new f.Buf8(l),
                                s.next_out = 0,
                                s.avail_out = l),
                                (n = u.inflate(s, m.Z_NO_FLUSH)) === m.Z_NEED_DICT && c && (i = "string" == typeof c ? h.string2buf(c) : "[object ArrayBuffer]" === b.call(c) ? new Uint8Array(c) : c,
                                n = u.inflateSetDictionary(this.strm, i)),
                                n === m.Z_BUF_ERROR && !0 === d && (n = m.Z_OK,
                                d = !1),
                                n !== m.Z_STREAM_END && n !== m.Z_OK)
                                    return this.onEnd(n),
                                    !(this.ended = !0)
                            } while (!s.next_out || 0 !== s.avail_out && n !== m.Z_STREAM_END && (0 !== s.avail_in || r !== m.Z_FINISH && r !== m.Z_SYNC_FLUSH) || ("string" === this.options.to ? (i = h.utf8border(s.output, s.next_out),
                            o = s.next_out - i,
                            a = h.buf2string(s.output, i),
                            s.next_out = o,
                            s.avail_out = l - o,
                            o && f.arraySet(s.output, s.output, i, o, 0),
                            this.onData(a)) : this.onData(f.shrinkBuf(s.output, s.next_out))),
                            0 === s.avail_in && 0 === s.avail_out && (d = !0),
                            (0 < s.avail_in || 0 === s.avail_out) && n !== m.Z_STREAM_END);
                            return (r = n === m.Z_STREAM_END ? m.Z_FINISH : r) === m.Z_FINISH ? (n = u.inflateEnd(this.strm),
                            this.onEnd(n),
                            this.ended = !0,
                            n === m.Z_OK) : r !== m.Z_SYNC_FLUSH || (this.onEnd(m.Z_OK),
                            !(s.avail_out = 0))
                        }
                        ,
                        ...
                        i.prototype.onEnd = function(e) {
                            e === m.Z_OK && ("string" === this.options.to ? this.result = this.chunks.join("") : this.result = f.flattenChunks(this.chunks)),
                            this.chunks = [],
                            this.err = e,
                    ...
                    "utils/strings.js": function(e, t, n) {
                        ...
                        n.string2buf = function(e) {
                            for (var t, n, r, o, a = e.length, i = 0, s = 0; s < a; s++)
                                55296 == (64512 & (n = e.charCodeAt(s))) && s + 1 < a && 56320 == (64512 & (r = e.charCodeAt(s + 1))) && (n = 65536 + (n - 55296 << 10) + (r - 56320),
                                s++),
                        ...
                        n.binstring2buf = function(e) {
                            for (var t = new l.Buf8(e.length), n = 0, r = t.length; n < r; n++)
                                t[n] = e.charCodeAt(n);
                            return t
                        }
                        ,
                    ...
                    "zlib/inflate.js": function(e, t, n) {
                        ...
                        function l(e, t) {
                            ...
                            t = -t) : (n = 1 + (t >> 4),
                            t < 48 && (t &= 15)),
                            t && (t < 8 || 15 < t)) ? O : (null !== r.window && r.wbits !== t && (r.window = null),
                            r.wrap = n,
                            r.wbits = t,
                            s(e))
                        }
                        ...
                        function Z(e, t, n, r) {
                            ...
                            r >= e.wsize ? (D.arraySet(e.window, t, n - e.wsize, e.wsize, 0),
                            e.wnext = 0,
                            e.whave = e.wsize) : (r < (o = e.wsize - e.wnext) && (o = r),
                            D.arraySet(e.window, t, n - r, o, e.wnext),
                            (r -= o) ? (D.arraySet(e.window, t, n - r, r, 0),
                            e.wnext = r,
                            e.whave = e.wsize) : (e.wnext += o,
                        ...
                        n.inflate = function(e, t) {
                            var n, r, o, a, i, s, l, c, d, u, f, h, m, b, p, g, w, v, y, k, _, x, S, E, C = 0, U = new D.Buf8(4), A = [16, 17, 18, 0, 8, 7, 9, 6, 10, 5, 11, 4, 12, 3, 13, 2, 14, 1, 15];
                            ...
                            e: for (; ; )
                                ...
                                case 5:
                                    ...
                                    n.mode = 6;
                                case 6:
                                    if (1024 & n.flags && ((h = s < (h = n.length) ? s : h) && (n.head && (_ = n.head.extra_len - n.length,
                                ...
                                case 7:
                                    if (2048 & n.flags) {
                                        ...
                                        _ && h < s; )
                                            ;
                                        if (512 & n.flags && (n.check = R(n.check, r, h, a)),
                                        s -= h,
                                        a += h,
                                        _)
                                            break e
                                ...
                                case 13:
                                    if (n.last)
                                        ...
                                        case 0:
                                            ...
                                            break;
                                        case 1:
                                            var T, T = P = void 0, P = n;
                                            if (W) {
                                                for (M = new D.Buf32(512),
                                                H = new D.Buf32(32),
                                                T = 0; T < 144; )
                                                    P.lens[T++] = 8;
                                                for (; T < 256; )
                                                ...
                                                for (; T < 288; )
                                                    P.lens[T++] = 8;
                                                for (z(1, P.lens, 0, 288, M, 0, P.work, {
                                                    bits: 9
                                                }),
                                                T = 0; T < 32; )
                                                    P.lens[T++] = 5;
                                                z(2, P.lens, 0, 32, H, 0, P.work, {
                                                    bits: 5
                                                }),
                                                W = !1
                                            }
                                ...
                                case 19:
                                    for (; n.have < n.nlen + n.ndist; ) {
                                        for (; g = (C = n.lencode[c & (1 << n.lenbits) - 1]) >>> 16 & 255,
                                        w = 65535 & C,
                                        !((p = C >>> 24) <= d); ) {
                                            if (0 === s)
                                                break e;
                                    ...
                                    x = z(1, n.lens, 0, n.nlen, n.lencode, 0, n.work, S),
                                    n.lenbits = S.bits,
                                    x) {
                                    ...
                                    x = z(2, n.lens, n.nlen, n.ndist, n.distcode, 0, n.work, S),
                                    n.distbits = S.bits,
                                    x) {
                                ...
                                case 21:
                                    ...
                                    for (n.back = 0; g = (C = n.lencode[c & (1 << n.lenbits) - 1]) >>> 16 & 255,
                                    w = 65535 & C,
                                    !((p = C >>> 24) <= d); ) {
                                        if (0 === s)
                                            break e;
                                    ...
                                    if (g && 0 == (240 & g)) {
                                        for (v = p,
                                        y = g,
                                        k = w; g = (C = n.lencode[k + ((c & (1 << v + y) - 1) >> v)]) >>> 16 & 255,
                                        w = 65535 & C,
                                        !(v + (p = C >>> 24) <= d); ) {
                                            if (0 === s)
                                                break e;
                                ...
                                case 22:
                                    ...
                                    n.mode = 23;
                                case 23:
                                    for (; g = (C = n.distcode[c & (1 << n.distbits) - 1]) >>> 16 & 255,
                                    w = 65535 & C,
                                    !((p = C >>> 24) <= d); ) {
                                        if (0 === s)
                                            break e;
                                    ...
                                    if (0 == (240 & g)) {
                                        for (v = p,
                                        y = g,
                                        k = w; g = (C = n.distcode[k + ((c & (1 << v + y) - 1) >> v)]) >>> 16 & 255,
                                        w = 65535 & C,
                                        !(v + (p = C >>> 24) <= d); ) {
                                            if (0 === s)
                                                break e;
                                ...
                                case 27:
                                    if (n.wrap) {
                                        ...
                                        e.total_out += f,
                                        n.total += f,
                                        f && (e.adler = n.check = (n.flags ? R : B)(n.check, o, f, i - f)),
                                        f = l,
                            ...
                            n.hold = c,
                            n.bits = d,
                            (n.wsize || f !== e.avail_out && n.mode < 30 && (n.mode < 27 || 4 !== t)) && Z(e, e.output, e.next_out, f - e.avail_out) ? (n.mode = 31,
                            -4) : (u -= e.avail_in,
                            f -= e.avail_out,
                            e.total_in += u,
                            e.total_out += f,
                            n.total += f,
                            n.wrap && f && (e.adler = n.check = (n.flags ? R : B)(n.check, o, f, e.next_out - f)),
                        ...
                        n.inflateSetDictionary = function(e, t) {
                            var n, r = t.length;
                            return !e || !e.state || 0 !== (n = e.state).wrap && 11 !== n.mode ? O : 11 === n.mode && B(1, t, r, 0) !== n.check ? -3 : Z(e, t, r, r) ? (n.mode = 31,
                            -4) : (n.havedict = 1,
                            L)
                        }
                        ,
                    ...
                    "zlib/inffast.js": function(e, t, n) {
                        ...
                        t.exports = function(e, t) {
                            var n, r, o, a, i, s, l = e.state, c = e.next_in, d = e.input, u = c + (e.avail_in - 5), f = e.next_out, h = e.output, m = f - (t - e.avail_out), b = f + (e.avail_out - 257), p = l.dmax, g = l.wsize, w = l.whave, v = l.wnext, y = l.window, k = l.hold, _ = l.bits, x = l.lencode, S = l.distcode, E = (1 << l.lenbits) - 1, C = (1 << l.distbits) - 1;
                            e: do {
                                for (_ < 15 && (k += d[c++] << _,
                                _ += 8,
                                k += d[c++] << _,
                    ...
                    "zlib/inftrees.js": function(e, t, n) {
                        ...
                        t.exports = function(e, t, n, r, o, a, i, s) {
                            for (var l, c, d, u, f, h, m, b, p, g = s.bits, w = 0, v = 0, y = 0, k = 0, _ = 0, x = 0, S = 0, E = 0, C = 0, U = 0, A = null, T = 0, P = new I.Buf16(16), D = new I.Buf16(16), B = null, R = 0, w = 0; w <= 15; w++)
                                P[w] = 0;
                            for (v = 0; v < r; v++)
                                P[t[n + v]]++;
                            for (_ = g,
                            ...
                            0 === k)
                                ...
                                for (; ; ) {
                                    ...
                                    0),
                                    l = 1 << (m = w - S),
                                    y = c = 1 << x; o[f + (U >> S) + (c -= l)] = m << 24 | b << 16 | p | 0,
                                    0 !== c; )
                                        ;
                                    for (l = 1 << w - 1; U & l; )
                                        l >>= 1;
                                    ...
                                    if (_ < w && (U & u) !== d) {
                                        for (f += y,
                                        E = 1 << (x = w - (S = 0 === S ? _ : S)); x + S < k && !((E -= P[x + S]) <= 0); )
                                            x++,
                                            E <<= 1;
                                        if (C += 1 << x,
                                        1 === e && 852 < C || 2 === e && 592 < C)
                ...
                try {
                    for (var n in A) {
                        ...
                        if (A[n].hasUnityMarker(i))
                            ...
                            (r = A[n]).worker || (o = URL.createObjectURL(new Blob(["this.require = ", r.require.toString(), "; this.decompress = ", r.decompress.toString(), "; this.onmessage = ", function(e) {
                                e = {
                                    id: e.data.id,
    ...
    function P() {
        var t = performance.now()
          , m = (Promise.all([T("frameworkUrl").then(function(e) {
            ...
            return new Promise(function(a, e) {
                    ...
                    if ("undefined" == typeof unityFramework || !unityFramework) {
                        ...
                        for (e in t) {
                            ...
                            if (b.frameworkUrl.endsWith("." + r[0]))
                                return n = "Unable to parse " + b.frameworkUrl + "!",
                        ...
                        c("Unable to parse " + b.frameworkUrl + "! The file is corrupt, or compression was misconfigured? (check Content-Encoding HTTP Response Header on web server)", "error")
                    }
                ...
                i.onerror = function(e) {
                    c("Unable to load file " + b.frameworkUrl + "! Check that the file exists on the remote server. (also check browser Console and Devtools Network tab to debug)", "error")
                }
                ,
        ...
        b.preRun.push(function() {
            ...
            e.then(function(t) {
                ...
                for (n + s > t.length && o("Invalid binary data file header! (pos=" + n + ", headerSize=" + s + ", file length=" + t.length + ")"); n < s; ) {
                    var l = r()
                      , c = r()
                      , d = (l + c > t.length && o("Invalid binary data file size! (offset=" + l + ", size=" + c + ", file length=" + t.length + ")"),
                    r())
                      , u = (n + d > t.length && o("Invalid binary data file path name! (pos=" + n + ", length=" + d + ", file length=" + t.length + ")"),
                    e.decode(t.subarray(n, n + d)));
                    n += d;
                    for (var f = 0, h = u.indexOf("/", f) + 1; 0 < h; f = h,
                    h = u.indexOf("/", f) + 1)
    ...
    return new Promise(function(e, t) {
        var n;
        b.SystemInfo.hasWebGL ? 1 == b.SystemInfo.hasWebGL ? (n = 'Your browser does not support graphics API "WebGL 2" which is required for this content.',
        "Safari" == b.SystemInfo.browser && parseInt(b.SystemInfo.browserVersion) < 15 && (b.SystemInfo.mobile || 1 < navigator.maxTouchPoints ? n += "\nUpgrade to iOS 15 or later." : n += "\nUpgrade to Safari 15 or later."),
        t(n)) : b.SystemInfo.hasWasm ? (b.startupErrorHandler = t,
        l(0),
        b.postRun.push(function() {
            l(1),
            b.WebPlayer.WaitForInitialization().then(function() {
        ...
        new Promise(function(t, e) {
            navigator.gpu ? navigator.gpu.requestAdapter().then(function(e) {
                b.SystemInfo.hasWebGPU = !!e,
                t(b.SystemInfo.hasWebGPU)
            }) : t(!1)
        }
        ).then(function() {
            P()
